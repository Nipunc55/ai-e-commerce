...
const SignupForm = () => {
  ...
  return (
    <div className='auth_container'onSubmit={handleSubmit}>
        ...
        <div className='row mb-4'>
          <div className='col'>
            <div className='form-outline'>
              <input type='text' id='form3Example1' className='form-control' name={"name"} value={formData.name} onChange={handleChange} />
